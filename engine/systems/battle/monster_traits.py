"""
monster traits - Emergency Facade
==============================
...
class monstertraits:
    ...
    def __init__(self, battle_state: 'BattleState' = None):
        ...
        logger.info("monstertraits initialized")
...
def get_trait_system() -> monstertraits:
    """Get the singleton trait system instance."""
    global _trait_system_instance
    if _trait_system_instance is None:
        _trait_system_instance = monstertraits()
