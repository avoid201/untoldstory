...
class EntitySprite:
    ...
    frame_width: int = 64   # Korrigiert: 64x64 Pixel Sprites
    frame_height: int = 64  # Korrigiert: 64x64 Pixel Sprites
...
class Entity:
    ...
    def __init__(self,
                 x: float,
                 y: float,
                 width: int = 56,  # Korrigiert: 56 Pixel für 64x64 Tiles (14 * 4)
                 height: int = 56, # Korrigiert: 56 Pixel für 64x64 Tiles (14 * 4)
        ...
        self.velocity_x = 0.0
        self.velocity_y = 0.0
        self.speed = 240.0  # Korrigiert: 4x schneller für 64x64 Tiles (60.0 * 4)
        ...
        try:
            ...
            if self.sprite_config and self.sprite_config.animations:
                ...
                if frames:
                    ...
                    # Erstelle ein Rechteck für die Bildschirmposition
                ...
                # Keine Animation: Zeichne den kompletten Sprite zentriert
            ...
            fallback_rect = pygame.Rect(screen_x - 16, screen_y - 16, 32, 32)
