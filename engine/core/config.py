...
# Tile Settings
TILE_SIZE = 64  # Korrigiert: 64x64 Pixel Tiles
HALF_TILE = TILE_SIZE // 2
PLAYER_COLLISION_SIZE = 56  # Player collision box size within tile (14 * 4 für 64x64)

# Movement
PLAYER_SPEED = 8.0  # Korrigiert: 4x schneller für 64x64 Tiles (2.0 * 4)
NPC_SPEED = 4.0     # Korrigiert: 4x schneller für 64x64 Tiles (1.0 * 4)
RUN_MULTIPLIER = 1.5
...
class GraphicsConfig:
    ...
    # Sprite sizes
    PLAYER_SPRITE_SIZE = 64  # Korrigiert: 64x64 Pixel
    NPC_SPRITE_SIZE = 64     # Korrigiert: 64x64 Pixel
    MONSTER_SPRITE_SIZE = 64 # Korrigiert: 64x64 Pixel
...
# Camera
CAMERA_DEADZONE_WIDTH = 160  # Korrigiert: 4x größer für 64x64 Tiles (40 * 4)
CAMERA_DEADZONE_HEIGHT = 120 # Korrigiert: 4x größer für 64x64 Tiles (30 * 4)
CAMERA_FOLLOW_SPEED = 32.0   # Korrigiert: 4x schneller für 64x64 Tiles (8.0 * 4)
