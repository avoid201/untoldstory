...
### **SPRITES/ - Grafik-Assets**
```
sprites/
├── Constructed/          # 🏠 Möbel & Deko (64×64px)
│   ├── Cabinet_large.png
│   ├── Computer-type-01_large.png
│   ├── Bookshelf-type-01_large.png
│   └── ...
├── monsters/             # 🐉 Monster-Sprites (40×40, 48×48, 56×56px)
│   ├── 1.png bis 151.png
│   └── ...
├── npcs/                 # 👥 NPC-Sprites
├── Drafts/               # 📝 Entwürfe
├── Raw-water/            # 🌊 Wasser-Animationen
...
### **Tile-Größen**
- **Basis-Tiles:** 64×64 Pixel
- **Monster:** 40×40, 48×48, 56×56 Pixel
- **Möbel:** 64×64 Pixel
...
- **Tile-IDs:** String-Format ("1", "5", "21")
- **Dateinamen:** "Cabinet_large.png", "Computer-type-01_large.png"
- **Doppelte Einträge:** Beide Schlüssel verweisen auf denselben Sprite

### **Fallback-System**
- **Primär:** Exakte Dateinamen
- **Fallback:** `_large.png` Versionen
- **Fehlerbehandlung:** Rote Platzhalter für fehlende Sprites
...
- **Größe:** 10×8 Tiles
- **Tile-IDs:** [1, 7, 9]
  - **ID 1:** Gras (Grass-flat_large.png)
  - **ID 7:** Boden (Flooring-type-01_large.png)
  - **ID 9:** Boden (Flooring-type-01_large.png)

### **Kohlenstadt**
- **Größe:** 32×32 Tiles
- **Tile-IDs:** [1, 2, 4]
  - **ID 1:** Gras (Grass-flat_large.png)
  - **ID 2:** Weg (Path_large.png)
  - **ID 4:** Kiesweg (Path-Gravel_large.png)
...
### **Fehlende Sprites**
- **Problem:** Sprites mit falschen Namen
- **Lösung:** Automatische Suche nach `_large.png` Versionen
