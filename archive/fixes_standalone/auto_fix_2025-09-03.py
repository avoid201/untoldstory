...
'''
    ...
    if controller_file.exists():
        ...
        if "from engine.systems.unified_damage_calculator import" not in content:
            import_line = "from engine.systems.unified_damage_calculator import unified_damage_calculator\n"
