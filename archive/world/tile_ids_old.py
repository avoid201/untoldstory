# ARCHIVED: 2025-01-03 - Unused tile constants, replaced by dynamic GID mapping
"""
Tile ID Konstanten für das Untold Story Spiel.
Alle IDs basieren auf der tile_mapping.json und dem manifest.json.

REPLACED BY: Dynamic GID mapping in area.py and map_loader.py
- Tile constants no longer needed
- GID mapping handled dynamically from TMX/JSON data
- Sprite loading uses SpriteManager with dynamic names
"""
