...
try:
    ...
    from graphics.tile_renderer import TileRenderer
    ...
    try:
        ...
        tr._render_furniture_placement(dummy_screen, test_map_data, camera)
    ...
    try:
        tr._render_decoration(dummy_screen, test_map_data, camera)
    ...
    # Teste render_map
    try:
        tr.render_map(dummy_screen, test_map_data, camera)
